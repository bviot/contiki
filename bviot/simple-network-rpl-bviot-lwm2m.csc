...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/bviot/simple-udp-rpl/bviot-device.c</source>
      <commands>make bviot-device.cooja TARGET=cooja</commands>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype43</identifier>
      <description>device-lwm2m</description>
      <source>[CONTIKI_DIR]/bviot/simple-udp-rpl/bviot-device-lwm2m.c</source>
      <commands>make bviot-device-lwm2m.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>30.23242865120059</x>
        <y>33.41657238343873</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>58.20539425001205</x>
        <y>64.36396322405959</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>27.581025356563824</x>
        <y>73.66482390963274</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>38.63646559219034</x>
        <y>55.54431434700781</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype43</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.208346801699244 0.0 0.0 4.208346801699244 46.657164376385225 -117.02246490753507</viewport>
    </plugin_config>
    <width>401</width>
    <z>2</z>
    <height>400</height>
